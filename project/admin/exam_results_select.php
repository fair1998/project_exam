        ...
        <div class="col-lg-12">
            <div class="user-data m-b-30">
                ...
                <div class="filters m-b-20">
                    <div class="row">
                        <div class="col-lg-4">
                            <form action="exam_results_select.php" method="GET">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $r1->sj_name ?></td>
                                        <td>
                                            <a class="btn btn-warning" href="exam_results_manage.php?ck_id=<?= $r1->ck_id; ?>">
                            ...
                            <ul class="pagination">
                                <?php for ($i = 1; $i <= $number_of_pages; $i++) { ?>
                                    <li <?php if ($page == $i) echo 'class="page-item active"'; ?>>
                                        <a class="page-link" href="exam_results_select.php?page=<?php echo $i; ?>&search=<?php echo $s_h; ?>&class=<?php echo $class; ?>"><?php echo $i; ?></a>
                                    </li>
                                <?php }; ?>
                            </ul>
                        </nav>

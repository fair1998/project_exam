                    ...
                    <div class="modal-body">
                        <div class="container-fluid myplr35">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="company" class=" form-control-label"><strong>ชื่อชุดข้อสอบ	</strong></label>
                                        <input type="text" disabled value="' . $r->es_name . '" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="company" class=" form-control-label"><strong>ข้อสอบ</strong></label>
...
if (isset($_POST["insert"])) {
    ...
    if ($con->query($sql)) {
        ...
        header("location:exam_set_manage.php?ck_id=$ck_id");
    }
}
...
if (isset($_GET["random"])) {
    ...
    header("location:exam_set_choose_exam.php?ck_id=$ck_id&es_id=$es_id");
}

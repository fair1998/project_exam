...
<body class="animsition">
    ...
    where es.ck_id = '$ck_id' and es.es_id = '$es_id'";
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="user-data m-b-30">
                ...
                <!-- row 1 -->
                <div class="filters m-b-5">
                    <div class="row">
                        <div class="col-lg-12" align="right">
                            <button type="button" class="btn btn-info" onclick="window.location.href='statistic_manage.php?ck_id=<?= $ck_id ?>'">
                                Back
                            </button>
                        </div>
                    </div>

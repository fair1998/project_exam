            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <strong>แก้ไขข้อมูลชุดข้อสอบ</strong>
                        </div>
                    </div>
                </div>
                <div class="card-body card-block">
                    <form action="exam_set_controller.php" method="post" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="es_name" value="<?= $r2->es_name ?>" maxlength="50" class="form-control" required>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label class=" form-control-label">ข้อสอบ</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <input type="text" name="es_sum" value="<?= $r2->es_sum ?>" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" maxlength="3" class="form-control" required>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="es_score" value="<?= $r2->es_score ?>" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" maxlength="3" class="form-control" required>
                            </div>
                        </div>
                </div>
                <div class="card-footer" align="center">
                    <input type="hidden" name="update" value="<?= $es_id ?>">
